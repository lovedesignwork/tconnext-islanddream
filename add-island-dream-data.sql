-- =====================================================
-- Island Dream Exploration - Add Sample Data
-- =====================================================
-- Run this in Supabase SQL Editor to populate your dashboard
-- This adds sample programs, hotels, agents, etc. for your company
-- =====================================================

-- Your company ID (already exists)
-- Company: TConnext Island Dream
...
INSERT INTO agents (company_id, name, contact_person, email, phone, status, agent_type, commission_rate, created_at)
VALUES 
    -- Local Agents
    ('00000000-0000-0000-0000-000000000001', 
...
VALUES 
    ('00000000-0000-0000-0000-000000000001', 'Somchai Phuket', 'Som', '+66845678901', 'Van', 10, 'active', NOW()),
    ('00000000-0000-0000-0000-000000000001', 'Niran Chaiyaporn', 'Nui', '+66856789012', 'Minibus', 15, 'active', NOW()),
    ('00000000-0000-0000-0000-000000000001', 'Prasert Somboon', 'Pom', '+66867890123', 'Van', 12, 'active', NOW()),
    ('00000000-0000-0000-0000-000000000001', 'Wichai Tanaka', 'Lek', '+66878901234', 'Minibus', 20, 'active', NOW())
ON CONFLICT DO NOTHING;
