                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-[90px] flex-shrink-0">
                      ...
                      <div className="bg-gray-100 rounded-lg px-3 py-4 text-center">
                        <NumberInput
                          min={0}
                          ...
                          className="text-2xl font-bold text-center border-0 bg-transparent p-0 h-auto"
                        />
                      </div>
                    </div>
                    ...
                    <div className="w-[90px] flex-shrink-0">
                      ...
                      <div className="bg-yellow-100 rounded-lg px-3 py-4 text-center">
