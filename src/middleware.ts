...
const publicApiRoutes = ['/api/public', '/api/auth/login', '/api/auth/forgot-password', '/api/auth/me', '/api/driver-portal', '/api/driver/', '/api/guide/', '/api/booking/', '/api/stripe/', '/api/branding', '/api/debug/']
