...
export default function GuidesSetupPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editingGuide) {
        ...
        // Only update PIN if a new one was provided (store as plain text)
        if (formData.pin) {
          updateData.access_pin = formData.pin
        }
  ...
  return (
    <ProtectedPage pageKey="guides" pageName="Guide Setup">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  placeholder={editingGuide ? 'Leave empty to keep current' : '0000'}
                  maxLength={4}
